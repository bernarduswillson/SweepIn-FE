...
const Sidebar = (props: SidebarProps) => {
  ...
  return (
    <div className={`${isOpen ? 'w-[240px]' : 'w-[30px]'} relative transition-width duration-200 ease-in-out`}>
      <div className={`fixed h-screen top-0 left-0 bottom-0 ${isOpen ? 'w-[240px]' : 'w-[30px]'} p-3 bg-blue_main transition-width duration-200 ease-in-out shadow-lg shadow-black/60`}>
