        ...
        <div className='mb-7'>
          ...
          <div className="max-w-[355px] w-full flex flex-wrap justify-left gap-[15px]">
          {
            ...
            photosBase64.map((photo, index) => (
              <div key={index} className="relative w-[170px] h-[170px] bg-grey_bg flex justify-center items-center overflow-hidden rounded-lg">
        ...
        <div className='w-full flex'>
          <div className='w-1/2'>
            <div className='mb-7'>
              ...
              <p className="text-black text-xl poppins-medium">{date2String(new Date(data.date))}</p>
            </div>
            <div className='mb-7'>
              <h2 className="poppins-bold text-blue_main">Deskripsi</h2>
              <p className="text-black text-xl poppins-medium">{data.description}</p>
            </div>
          </div>
          <div className='w-1/2'>
            <div className='mb-7'>
              <h2 className="poppins-bold text-blue_main">Waktu</h2>
              <p className="text-black text-xl poppins-medium">{dateTime2String(new Date(data.date))}</p>
            </div>
            <div className='mb-7'>
