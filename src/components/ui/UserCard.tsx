...
const Card = (props: UserCardProps): JSX.Element => {
  ...
  return (
    <div className='w-full'>
      <div className='w-full relative rounded-xl flex justify-between items-center cursor-pointer bg-grey_bg p-3 mb-3 group' onClick={handleClick}>
        <div className='w-full flex flex-col'>

          {/* Role */}
          <div className='poppins-bold text-sm text-blue_main'>
            {role}
          </div>

          {/* Name */}
          <div className='poppins-bold text-2xl text-black'>
            {name}
          </div>
